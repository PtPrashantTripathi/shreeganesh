...
public:
	MRect() { reset(); }
	MRect(const double &x0, const double &y0, const double &w, const double &h)
	{
		x = x0;
		y = y0;
		width = w;
	...
	MRect(const MPoint &p, const double &w, const double &h)
	{
		x = p.real();
		y = p.imag();
		width = w;
	...
	MRect(const MPoint &p, const MPoint &q)
	{
		x = p.real();
		y = p.imag();
		width = q.real();
...
#define ASSERT_VALID_OBJECT(p) \
	assert((p >= FIRST_EPHEM_OBJECT && p <= LAST_EPHEM_OBJECT) || (p >= FIRST_EXTENDED_OBJECT && p <= LAST_EXTENDED_OBJECT) || (p >= FIRST_ARABIC_OBJECT && p <= LAST_ARABIC_OBJECT) || (p >= OHOUSE1 && p <= OHOUSE12));
...
enum
{
	EPHEM_COORDINATES_GEOCENTRIC = 0,
	EPHEM_COORDINATES_TOPOCENTRIC,
	EPHEM_COORDINATES_EQUATORIAL,
	EPHEM_COORDINATES_BARYCENTRIC,
	EPHEM_COORDINATES_HELIOCENTRIC
};
...
enum
{
	VCC_NOTHING = 0,
	VCC_NAME,
	VCC_NAME_SIGNIFICATION,
	VCC_DIVISION,
	VCC_DIVISION_SIGNIFICATION
};
...
enum
{
	DEG_PRECISION_MINUTE,
	DEG_PRECISION_SECOND,
	DEG_PRECISION_MORE,
	DEG_PRECISION_FLEXIBLE
};
...
enum
{
	KALAVELA_PORTION_START = 0,
	KALAVELA_PORTION_MIDDLE,
	KALAVELA_PORTION_END
};
...
enum FONT_ID
{ // FONT_HTML_DEFAULT = 0,
	FONT_GRAPHIC_DEFAULT = 0,
	FONT_GRAPHIC_SYMBOLS,
	FONT_TEXT_DEFAULT,
	FONT_TEXT_HEADER,
	FONT_TEXT_TABLE_CONTENTS,
	FONT_TEXT_TABLE_HEADER,
	FONT_PDF_DEFAULT,
	FONT_PDF_HEADER,
	FONT_PDF_TABLE_CONTENTS,
	FONT_PDF_TABLE_HEADER,
	FONT_PDF_TINY,
	FONT_PLAIN_DEFAULT
};
...
enum TAB_CELL_TYPE
{
	...
	TAB_CELL_FULL_DATE,
	TAB_CELL_LOCAL_TIME,
	TAB_CELL_UNIVERSAL_TIME,
	TAB_CELL_TZ_NAME,
	TAB_CELL_DST,
	TAB_CELL_LOCATION_NAME,
	TAB_CELL_LOCATION_LONGITUDE,
	TAB_CELL_LOCATION_LATITUDE,

	TAB_CELL_WEEKDAY,
	TAB_CELL_JULIAN_DATE,
	TAB_CELL_SIDEREAL_TIME,
	TAB_CELL_VEDIC_AYANAMSA,
	TAB_CELL_WESTERN_AYANAMSA,
	TAB_CELL_HORA_LORD,
	TAB_CELL_DINA_LORD,
	TAB_CELL_MASA_LORD,
	TAB_CELL_VARSHA_LORD,
	TAB_CELL_LUNAR_TITHI,
	TAB_CELL_SUNRISE,
	TAB_CELL_SUNSET,
	TAB_CELL_VARNA,
	TAB_CELL_GANA,
