export function getConjunctionSaravali(
    ...
    return [
        {
            ...
            rule: planets.Sun.rasi.rasi_num == planets.Moon.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Moon = Mars",
                hindi: "सूर्य = चंद्रमा = मंगल",
            },
            effect: {
                english:
            ...
            rule:
                planets.Sun.rasi.rasi_num == planets.Moon.rasi.rasi_num &&
                planets.Sun.rasi.rasi_num == planets.Mars.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Moon = Mars = Mercury",
                hindi: "सूर्य = चंद्रमा = मंगल = बुध",
            },
            effect: {
                english:
            ...
            rule:
                planets.Sun.rasi.rasi_num == planets.Moon.rasi.rasi_num &&
                planets.Sun.rasi.rasi_num == planets.Mars.rasi.rasi_num &&
                planets.Sun.rasi.rasi_num == planets.Mercury.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Moon = Mars = Jupiter",
                hindi: "सूर्य = चंद्रमा = मंगल = बृहस्पति",
            },
            effect: {
                english:
            ...
            rule:
                planets.Sun.rasi.rasi_num == planets.Moon.rasi.rasi_num &&
                planets.Sun.rasi.rasi_num == planets.Mars.rasi.rasi_num &&
                planets.Sun.rasi.rasi_num == planets.Jupiter.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Moon = Mars = Venus",
                hindi: "सूर्य = चंद्रमा = मंगल = शुक्र",
            },
            effect: {
                english:
            ...
            rule:
                planets.Sun.rasi.rasi_num == planets.Moon.rasi.rasi_num &&
                planets.Sun.rasi.rasi_num == planets.Mars.rasi.rasi_num &&
                planets.Sun.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Moon = Mars = Saturn",
                hindi: "सूर्य = चंद्रमा = मंगल = शनि",
            },
            effect: {
                english:
            ...
            rule:
                planets.Sun.rasi.rasi_num == planets.Moon.rasi.rasi_num &&
                planets.Sun.rasi.rasi_num == planets.Mars.rasi.rasi_num &&
                planets.Sun.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Moon = Mercury",
                hindi: "सूर्य = चंद्रमा = बुध",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Moon = Mercury = Jupiter",
                hindi: "सूर्य = चंद्रमा = बुध = बृहस्पति",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Moon = Mercury = Venus",
                hindi: "सूर्य = चंद्रमा = बुध = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Moon = Mercury = Saturn",
                hindi: "सूर्य = चंद्रमा = बुध = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Moon = Jupiter",
                hindi: "सूर्य = चंद्रमा = बृहस्पति",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Moon = Jupiter = Venus",
                hindi: "सूर्य = चंद्रमा = बृहस्पति = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Moon = Jupiter = Saturn",
                hindi: "सूर्य = चंद्रमा = बृहस्पति = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Moon = Venus",
                hindi: "सूर्य = चंद्रमा = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Moon = Venus = Saturn",
                hindi: "सूर्य = चंद्रमा = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Moon = Saturn",
                hindi: "सूर्य = चंद्रमा = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Sun.rasi.rasi_num == planets.Mars.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Mars = Mercury",
                hindi: "सूर्य = मंगल = बुध",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mercury = Mars = Jupiter",
                hindi: "सूर्य = बुध = मंगल = बृहस्पति",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mercury = Mars = Venus",
                hindi: "सूर्य = बुध = मंगल = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mercury = Mars = Saturn",
                hindi: "सूर्य = बुध = मंगल = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mars = Jupiter",
                hindi: "सूर्य = मंगल = बृहस्पति",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mars = Jupiter = Venus",
                hindi: "सूर्य = मंगल = बृहस्पति = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mars = Jupiter = Saturn",
                hindi: "सूर्य = मंगल = बृहस्पति = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mars = Venus",
                hindi: "सूर्य = मंगल = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mars = Venus = Saturn",
                hindi: "सूर्य = मंगल = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mars = Saturn",
                hindi: "सूर्य = मंगल = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Sun.rasi.rasi_num == planets.Mercury.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Mercury = Jupiter",
                hindi: "सूर्य = बुध = बृहस्पति",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mercury = Jupiter = Venus",
                hindi: "सूर्य = बुध = बृहस्पति = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mercury = Jupiter = Saturn",
                hindi: "सूर्य = बुध = बृहस्पति = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mercury = Venus",
                hindi: "सूर्य = बुध = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Mercury = Saturn = Venus",
                hindi: "सूर्य = बुध = शनि = शुक्र",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Sun.rasi.rasi_num == planets.Jupiter.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Jupiter = Venus",
                hindi: "सूर्य = बृहस्पति = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Jupiter = Venus = Saturn",
                hindi: "सूर्य = बृहस्पति = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Sun = Jupiter = Saturn",
                hindi: "सूर्य = बृहस्पति = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Sun.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Sun = Venus = Saturn",
                hindi: "सूर्य = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Sun.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
            ...
            rule: planets.Moon.rasi.rasi_num == planets.Mars.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Moon = Mercury = Mars",
                hindi: "चंद्रमा = बुध = मंगल",
            },
            effect: {
                english:
            ...
            rule:
                planets.Moon.rasi.rasi_num == planets.Mercury.rasi.rasi_num &&
                planets.Moon.rasi.rasi_num == planets.Mars.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Moon = Mercury = Mars = Jupiter",
                hindi: "चंद्रमा = बुध = मंगल = बृहस्पति",
            },
            effect: {
                english:
            ...
            rule:
                planets.Moon.rasi.rasi_num == planets.Mercury.rasi.rasi_num &&
                planets.Moon.rasi.rasi_num == planets.Mars.rasi.rasi_num &&
                planets.Moon.rasi.rasi_num == planets.Jupiter.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Moon = Mercury = Mars = Saturn",
                hindi: "चंद्रमा = बुध = मंगल = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Mercury = Mars = Venus",
                hindi: "चंद्रमा = बुध = मंगल = शुक्र",
            },
            effect: {
                english:
            ...
            rule:
                planets.Moon.rasi.rasi_num == planets.Mercury.rasi.rasi_num &&
                planets.Moon.rasi.rasi_num == planets.Mars.rasi.rasi_num &&
                planets.Moon.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Moon = Jupiter = Mars",
                hindi: "चंद्रमा = बृहस्पति = मंगल",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Mars = Jupiter = Venus",
                hindi: "चंद्रमा = मंगल = बृहस्पति = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Mars = Jupiter = Saturn",
                hindi: "चंद्रमा = मंगल = बृहस्पति = शनि",
            },
            effect: {
                english:
            ...
            rule:
                planets.Moon.rasi.rasi_num == planets.Mars.rasi.rasi_num &&
                planets.Moon.rasi.rasi_num == planets.Jupiter.rasi.rasi_num &&
                planets.Moon.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Moon = Venus = Mars",
                hindi: "चंद्रमा = शुक्र = मंगल",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Mars = Venus = Saturn",
                hindi: "चंद्रमा = मंगल = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Saturn = Mars",
                hindi: "चंद्रमा = शनि = मंगल",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Moon.rasi.rasi_num == planets.Mercury.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Moon = Mercury = Jupiter",
                hindi: "चंद्रमा = बुध = बृहस्पति",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Mercury = Jupiter = Venus",
                hindi: "चंद्रमा = बुध = बृहस्पति = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Mercury = Jupiter = Saturn",
                hindi: "चंद्रमा = बुध = बृहस्पति = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Mercury = Venus",
                hindi: "चंद्रमा = बुध = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Mercury = Venus = Saturn",
                hindi: "चंद्रमा = बुध = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Mercury = Saturn",
                hindi: "चंद्रमा = बुध = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Jupiter",
                hindi: "चंद्रमा = बृहस्पति",
            },
            effect: {
                english:
            ...
            rule: planets.Moon.rasi.rasi_num == planets.Jupiter.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Moon = Jupiter = Venus",
                hindi: "चंद्रमा = बृहस्पति = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Jupiter = Venus = Saturn",
                hindi: "चंद्रमा = बृहस्पति = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Moon = Jupiter = Saturn",
                hindi: "चंद्रमा = बृहस्पति = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Moon.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Moon = Venus = Saturn",
                hindi: "चंद्रमा = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Moon.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mars = Mercury",
                hindi: "मंगल = बुध",
            },
            effect: {
                english:
            ...
            rule: planets.Mars.rasi.rasi_num == planets.Mercury.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mercury = Mars = Jupiter",
                hindi: "बुध = मंगल = बृहस्पति",
            },
            effect: {
                english:
            ...
            rule:
                planets.Mercury.rasi.rasi_num == planets.Mars.rasi.rasi_num &&
                planets.Mercury.rasi.rasi_num == planets.Jupiter.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mercury = Mars = Jupiter = Venus",
                hindi: "बुध = मंगल = बृहस्पति = शुक्र",
            },
            effect: {
                english:
            ...
            rule:
                ...
                planets.Mercury.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mercury = Mars = Jupiter = Saturn",
                hindi: "बुध = मंगल = बृहस्पति = शनि",
            },
            effect: {
                english:
            ...
            rule:
                ...
                planets.Mercury.rasi.rasi_num ==
                    planets.Jupiter.rasi.rasi_num &&
                planets.Mercury.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mercury = Mars = Venus",
                hindi: "बुध = मंगल = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Mercury = Mars = Venus = Saturn",
                hindi: "बुध = मंगल = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Mars.rasi.rasi_num == planets.Jupiter.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mars = Jupiter = Venus",
                hindi: "मंगल = बृहस्पति = शुक्र",
            },
            effect: {
                english:
            ...
            rule:
                planets.Mars.rasi.rasi_num == planets.Jupiter.rasi.rasi_num &&
                planets.Mars.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mars = Jupiter = Venus = Saturn",
                hindi: "मंगल = बृहस्पति = शुक्र = शनि",
            },
            effect: {
                english:
            ...
            rule:
                planets.Mars.rasi.rasi_num == planets.Jupiter.rasi.rasi_num &&
                planets.Mars.rasi.rasi_num == planets.Venus.rasi.rasi_num &&
                planets.Mars.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mars = Jupiter = Saturn",
                hindi: "मंगल = बृहस्पति = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Mars.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mars = Venus = Saturn",
                hindi: "मंगल = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Mars.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mercury = Jupiter",
                hindi: "बुध = बृहस्पति",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Mercury = Jupiter = Venus",
                hindi: "बुध = बृहस्पति = शुक्र",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Mercury = Jupiter = Venus = Saturn",
                hindi: "बुध = बृहस्पति = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        {
            description: {
                english: "Mercury = Jupiter = Saturn",
                hindi: "बुध = बृहस्पति = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Mercury.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Mercury = Venus = Saturn",
                hindi: "बुध = शुक्र = शनि",
            },
            effect: {
                english:
        ...
        },
        {
            ...
            rule: planets.Mercury.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Jupiter = Venus",
                hindi: "बृहस्पति = शुक्र",
            },
            effect: {
                english:
            ...
            rule: planets.Jupiter.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Jupiter = Venus = Saturn",
                hindi: "बृहस्पति = शुक्र = शनि",
            },
            effect: {
                english:
            ...
            rule:
                planets.Saturn.rasi.rasi_num == planets.Jupiter.rasi.rasi_num &&
                planets.Saturn.rasi.rasi_num == planets.Venus.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Jupiter = Saturn",
                hindi: "बृहस्पति = शनि",
            },
            effect: {
                english:
            ...
            rule: planets.Jupiter.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
        {
            description: {
                english: "Venus = Saturn",
                hindi: "शुक्र = शनि",
            },
            effect: {
                english:
            ...
            rule: planets.Venus.rasi.rasi_num == planets.Saturn.rasi.rasi_num,
            highervargas: true,
        },
    ];
}
