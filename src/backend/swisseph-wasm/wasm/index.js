async function Module(moduleArg = {}) {
    ...
    var _swe_degnorm,
        ...
        _swe_cs2degstr,
        _swe_split_deg,
        _swe_set_astro_models,
        _swe_get_astro_models,
        _emscripten_stack_get_end,
        _emscripten_stack_get_base,
        _sbrk,
        _emscripten_stack_init;
    function assignWasmExports(wasmExports) {
        Module["_swe_degnorm"] = _swe_degnorm = wasmExports["p"];
        Module["_swe_vis_limit_mag"] = _swe_vis_limit_mag = wasmExports["q"];
        Module["_swe_revjul"] = _swe_revjul = wasmExports["r"];
        Module["_swe_set_topo"] = _swe_set_topo = wasmExports["s"];
        Module["_swe_deltat_ex"] = _swe_deltat_ex = wasmExports["t"];
        Module["_swe_calc"] = _swe_calc = wasmExports["u"];
        Module["_swe_fixstar"] = _swe_fixstar = wasmExports["v"];
        Module["_swe_azalt"] = _swe_azalt = wasmExports["w"];
        Module["_swe_pheno_ut"] = _swe_pheno_ut = wasmExports["x"];
        Module["_swe_fixstar_mag"] = _swe_fixstar_mag = wasmExports["y"];
        Module["_swe_topo_arcus_visionis"] = _swe_topo_arcus_visionis =
            wasmExports["z"];
        Module["_swe_heliacal_angle"] = _swe_heliacal_angle = wasmExports["A"];
        Module["_swe_heliacal_pheno_ut"] = _swe_heliacal_pheno_ut =
            wasmExports["B"];
        Module["_swe_heliacal_ut"] = _swe_heliacal_ut = wasmExports["C"];
        Module["_swe_get_planet_name"] = _swe_get_planet_name =
            wasmExports["D"];
        Module["_swe_rise_trans"] = _swe_rise_trans = wasmExports["E"];
        Module["_swe_calc_ut"] = _swe_calc_ut = wasmExports["F"];
        Module["_swe_houses"] = _swe_houses = wasmExports["G"];
        Module["_swe_sidtime0"] = _swe_sidtime0 = wasmExports["H"];
        Module["_swe_houses_armc_ex2"] = _swe_houses_armc_ex2 =
            wasmExports["I"];
        Module["_swe_difdeg2n"] = _swe_difdeg2n = wasmExports["J"];
        Module["_swe_houses_ex"] = _swe_houses_ex = wasmExports["K"];
        Module["_swe_houses_ex2"] = _swe_houses_ex2 = wasmExports["L"];
        Module["_swe_set_sid_mode"] = _swe_set_sid_mode = wasmExports["M"];
        Module["_swe_get_ayanamsa_ex"] = _swe_get_ayanamsa_ex =
            wasmExports["N"];
        Module["_swe_houses_armc"] = _swe_houses_armc = wasmExports["O"];
        Module["_swe_cotrans"] = _swe_cotrans = wasmExports["P"];
        Module["_swe_radnorm"] = _swe_radnorm = wasmExports["Q"];
        Module["_swe_house_name"] = _swe_house_name = wasmExports["R"];
        Module["_swe_house_pos"] = _swe_house_pos = wasmExports["S"];
        Module["_swe_sol_eclipse_where"] = _swe_sol_eclipse_where =
            wasmExports["T"];
        Module["_swe_sidtime"] = _swe_sidtime = wasmExports["U"];
        ...
        Module["_swe_lun_occult_when_loc"] = _swe_lun_occult_when_loc =
            wasmExports["$"];
        Module["_swe_azalt_rev"] = _swe_azalt_rev = wasmExports["aa"];
        Module["_swe_refrac"] = _swe_refrac = wasmExports["ba"];
        Module["_swe_set_lapse_rate"] = _swe_set_lapse_rate = wasmExports["ca"];
        ...
        Module["_swe_rise_trans_true_hor"] = _swe_rise_trans_true_hor =
            wasmExports["ga"];
        Module["_swe_pheno"] = _swe_pheno = wasmExports["ha"];
        Module["_swe_nod_aps"] = _swe_nod_aps = wasmExports["ia"];
        Module["_swe_nod_aps_ut"] = _swe_nod_aps_ut = wasmExports["ja"];
        Module["_swe_get_orbital_elements"] = _swe_get_orbital_elements =
            wasmExports["ka"];
        Module["_swe_orbit_max_min_true_distance"] =
            _swe_orbit_max_min_true_distance = wasmExports["la"];
        Module["_swe_gauquelin_sector"] = _swe_gauquelin_sector =
            wasmExports["ma"];
        Module["_swe_version"] = _swe_version = wasmExports["na"];
        Module["_swe_get_library_path"] = _swe_get_library_path =
            wasmExports["oa"];
        Module["_swe_set_tid_acc"] = _swe_set_tid_acc = wasmExports["pa"];
        Module["_free"] = _free = wasmExports["qa"];
        Module["_swe_set_ephe_path"] = _swe_set_ephe_path = wasmExports["ra"];
        Module["_swe_difrad2n"] = _swe_difrad2n = wasmExports["sa"];
        Module["_swe_close"] = _swe_close = wasmExports["ta"];
        Module["_swe_set_jpl_file"] = _swe_set_jpl_file = wasmExports["ua"];
        Module["_swe_get_ayanamsa_ex_ut"] = _swe_get_ayanamsa_ex_ut =
            wasmExports["va"];
        Module["_swe_get_ayanamsa"] = _swe_get_ayanamsa = wasmExports["wa"];
        Module["_swe_get_ayanamsa_ut"] = _swe_get_ayanamsa_ut =
            wasmExports["xa"];
        Module["_swe_fixstar2"] = _swe_fixstar2 = wasmExports["ya"];
        Module["_swe_fixstar2_ut"] = _swe_fixstar2_ut = wasmExports["za"];
        Module["_swe_fixstar2_mag"] = _swe_fixstar2_mag = wasmExports["Aa"];
        Module["_malloc"] = _malloc = wasmExports["Ba"];
        Module["_swe_get_ayanamsa_name"] = _swe_get_ayanamsa_name =
            wasmExports["Ca"];
        Module["_swe_time_equ"] = _swe_time_equ = wasmExports["Da"];
        Module["_swe_lmt_to_lat"] = _swe_lmt_to_lat = wasmExports["Ea"];
        Module["_swe_lat_to_lmt"] = _swe_lat_to_lmt = wasmExports["Fa"];
        Module["_swe_fixstar_ut"] = _swe_fixstar_ut = wasmExports["Ga"];
        Module["_swe_calc_pctr"] = _swe_calc_pctr = wasmExports["Ha"];
        Module["_swe_get_current_file_data"] = _swe_get_current_file_data =
            wasmExports["Ia"];
        Module["_swe_solcross"] = _swe_solcross = wasmExports["Ja"];
        Module["_swe_solcross_ut"] = _swe_solcross_ut = wasmExports["Ka"];
        Module["_swe_mooncross"] = _swe_mooncross = wasmExports["La"];
        Module["_swe_mooncross_ut"] = _swe_mooncross_ut = wasmExports["Ma"];
        Module["_swe_mooncross_node"] = _swe_mooncross_node = wasmExports["Na"];
        Module["_swe_mooncross_node_ut"] = _swe_mooncross_node_ut =
            wasmExports["Oa"];
        Module["_swe_helio_cross"] = _swe_helio_cross = wasmExports["Pa"];
        Module["_swe_helio_cross_ut"] = _swe_helio_cross_ut = wasmExports["Qa"];
        Module["_swe_date_conversion"] = _swe_date_conversion =
            wasmExports["Ra"];
        Module["_swe_julday"] = _swe_julday = wasmExports["Sa"];
        Module["_swe_utc_time_zone"] = _swe_utc_time_zone = wasmExports["Ta"];
        Module["_swe_utc_to_jd"] = _swe_utc_to_jd = wasmExports["Ua"];
        Module["_swe_jdet_to_utc"] = _swe_jdet_to_utc = wasmExports["Va"];
        Module["_swe_jdut1_to_utc"] = _swe_jdut1_to_utc = wasmExports["Wa"];
        Module["_swe_deg_midp"] = _swe_deg_midp = wasmExports["Xa"];
        Module["_swe_rad_midp"] = _swe_rad_midp = wasmExports["Ya"];
        Module["_swe_cotrans_sp"] = _swe_cotrans_sp = wasmExports["Za"];
        Module["_swe_deltat"] = _swe_deltat = wasmExports["_a"];
        Module["_swe_get_tid_acc"] = _swe_get_tid_acc = wasmExports["$a"];
        Module["_swe_set_delta_t_userdef"] = _swe_set_delta_t_userdef =
            wasmExports["ab"];
        Module["_swe_set_interpolate_nut"] = _swe_set_interpolate_nut =
            wasmExports["bb"];
        Module["_swe_csnorm"] = _swe_csnorm = wasmExports["cb"];
        Module["_swe_difcsn"] = _swe_difcsn = wasmExports["db"];
        Module["_swe_difdegn"] = _swe_difdegn = wasmExports["eb"];
        Module["_swe_difcs2n"] = _swe_difcs2n = wasmExports["fb"];
        Module["_swe_csroundsec"] = _swe_csroundsec = wasmExports["gb"];
        Module["_swe_d2l"] = _swe_d2l = wasmExports["hb"];
        Module["_swe_day_of_week"] = _swe_day_of_week = wasmExports["ib"];
        Module["_swe_cs2timestr"] = _swe_cs2timestr = wasmExports["jb"];
        Module["_swe_cs2lonlatstr"] = _swe_cs2lonlatstr = wasmExports["kb"];
        Module["_swe_cs2degstr"] = _swe_cs2degstr = wasmExports["lb"];
        Module["_swe_split_deg"] = _swe_split_deg = wasmExports["mb"];
        Module["_swe_set_astro_models"] = _swe_set_astro_models =
            wasmExports["nb"];
        Module["_swe_get_astro_models"] = _swe_get_astro_models =
            wasmExports["ob"];
        _emscripten_stack_get_end = wasmExports["pb"];
        _emscripten_stack_get_base = wasmExports["qb"];
        _sbrk = wasmExports["rb"];
        _emscripten_stack_init = wasmExports["sb"];
    }
    var wasmImports = {
