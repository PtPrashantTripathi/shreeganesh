import { DTR, RTD, TPI, DISFAC, COSSUN, COSZEN } from '../constants/index.js'
...
transit.calc = function (date, lha, dec, body, observer, result) {
	...
	result.UTdate = this.r_trnsit/TPI;
